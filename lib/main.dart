  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        "register2": (BuildContext context) => new SignUpPage(),
        "login_verification": (BuildContext context) =>
            new ScreenVerification(),
        "change_password_verification": (BuildContext context) =>
            new ChangePasswordVerification(),
